    ...
    <div className="bg-[#F1F1F1] -mt-40 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col md:flex-row justify-between items-center pt-40 mx-10 md:my-20 lg:my-0">
          <h1 className="text-6xl pb-7 lg:text-8xl max-w-lg font-bold text-gray-500 my-20 md:my-0  text-center">
            Favourite Projects
          </h1>
          <Link href="/projects">
        ...
        <div className="grid md:grid-cols-4 gap-8 lg:-mt-8 pb-40">
          {/* Single card */}
          <a
            href="https://scoala.stargymbistrita.ro/"
          ...
          {/* Single card */}
          <a
            href="https://shop-liart-two.vercel.app/"
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <h1 className="absolute bottom-10 left-10 text-blue-500 font-bold text-xl">
                02
              </h1>
            </div>
          </a>
          ...
          >
            <div className="relative overflow-hidden">
              ...
              <h1 className="absolute bottom-0 left-10 text-red-300 font-bold text-xl">
                03
              </h1>
            </div>
          </a>
